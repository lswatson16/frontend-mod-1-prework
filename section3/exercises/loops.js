...
// EXPLAIN:
// The variable "i" is logged to the console to display the value of "i" after each
// iterations. This example logs the iterations starting from an index value of zero
// to two.
