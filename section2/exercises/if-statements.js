...
// alternative method using logical operators
if (numQuarters === 2 || numQuarters > 2) {
console. log("I have enough money for a gumball");
} else{
console.log("I don't have enough money for a gumball");
}
...
I used a logical operator for the last exercise only.

Since it was mentioned, I added an alternative way using a logical operator
to the exercise with variable numQuarters.

Logical operators are symbols or words used to connect two or more expressions.
Logical operators include AND (&&) and OR (||). When applied to booleans, logical
