...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
/* I stored the variable firstName in a string because it's a name.
The variable isHungry is a boolean and I assigned it a value of "true".
The variable numberOfPets could be assigned as a string or number data type.
I used the number datatype in this exercise. */
