...
/* A string will be printed as a result of line 22 due to type coercion.
Javascript will convert the number into a string in order to combine the
two datatypes together. */
